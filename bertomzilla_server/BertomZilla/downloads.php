...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Downloads Statistics</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Downloads Statistics
                        </div>
                        <!-- /.panel-heading -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM operations WHERE type = '0' AND username = '".$_SESSION['username']."' ORDER BY id desc"; 
                                    ...
                                    <tbody>
                                         <?php 
                                            ...
                                            if (!isset($_GET['page']))
                                                ...
                                                $offset = $_GET['page'] * 50;
                                            $sql = "SELECT * FROM operations WHERE type = '0' AND username = '".$_SESSION['username']."' ORDER BY id DESC LIMIT 50 OFFSET ".$offset; 
                                            $req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error());
                                            $total_size = mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM operations WHERE type = '0' AND username = '".$_SESSION['username']."'"))[0];
                                            $i = 1;
                                            while ($data = mysql_fetch_assoc($req)) {
                                                $debit = $data['size'] / (1000000) / $data['time'];
                                                if ($debit == 0)
