...
<head>
    ...
    <title>BertomZilla - Speed details</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Speed Statistics</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Speed Statistics
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            while ($data = mysql_fetch_assoc($req)) {
                                                ...
                                                for ($incr = 0; $incr < 7; $incr++) {
                                                    if (!strncmp($data['date'], strftime("%Y-%m-%d", mktime(0, 0, 0, date('m'), date('d')-$incr, date('y'))), 10)) {
                                                        $tab[$incr] = ($tab[$incr] + number_format($debit, 2)) / 2;
                                                    }  
                                                }
                                            }
                                            ...
                                            if (!isset($_GET['page']))
                                                ...
                                                $offset = $_GET['page'] * 50;
                                            $sql = "SELECT * FROM operations WHERE username = '".$_SESSION['username']."' ORDER BY id DESC LIMIT 50 OFFSET ".$offset; 
                                            $req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error());
