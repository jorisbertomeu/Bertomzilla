...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Space Statistics</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Space Statistics
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            if (!isset($_GET['page']))
                                                ...
                                                $offset = $_GET['page'] * 50;
                                            $sql = "SELECT * FROM operations username WHERE username = '".$_SESSION['username']."' ORDER BY id DESC LIMIT 50 OFFSET ".$offset; 
                                            $req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error());
